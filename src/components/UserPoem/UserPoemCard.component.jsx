...
function UserPoemCard({ item, on, handleClick }) {
  return (
    <div class={`${styles.card} max-w-sm rounded overflow-hidden shadow-lg`}>
      ...
      <div class="px-6 pt-4 pb-2 flex justify-between">
        ...
        <div className="flex justify-end">
          ...
          <span class="inline-block bg-red-200 rounded px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 cursor-pointer ">
