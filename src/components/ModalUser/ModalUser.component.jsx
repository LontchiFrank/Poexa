...
import { editPoemAsync } from "../../features/poemSlice";

function ModalUser({ show, handleClickClose, infos, col }) {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(editPoemAsync(finalData));
  };
      ...
      {show ? (
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="bg-white p-2 rounded lg:w-1/2 sm:w-4/5">
            ...
            >
              <h1 className="text-xl font-bold pb-6">Edit Poem</h1>
